...
def build_bag_of_words(document):
  ...
  # word_excluded2 = ["하는", "은", "는", "이", "가", "와", "과", "으로", "로", "을", "를", "고", "이나", "적", "에", "게", "께", "에게", "에서",
  #                 "등", "적극", "대신", "와의", "의", "했다", "별", "약", "이상", "이외", "이하", "미만", "초과", "포함", "모든", "모두",
  #                 "부터", "까지", "되나", "도", "이미", "된", "한", "된다", "될", "해야", "한다", "할", "다", "이다", "있다", "위해", "위하",
  #                 "여", "이번", "것", "명", "일", "하", "ㄴ", "아요", "요", "ㄴ다", "세", "ㄹ", "되", "들", "있", "며", "단", "었", "어",
  #                 "두", "년", "시", "원", "수", "도록", "기", "지", "면", "연", "만", "간", "더", "그동안", "겠", "通", "아", "오", "으니", "니",
  #                 "...", "['", "']", "^", "“", "”", ",", "‘", "’", "△", "▲", "◇", "[", "]", "(", ")", "·", "~", "%", "?", ":", "-", "!",
  #                 "1", "2", "3", "4", "5", "6", "7", "8", "9", "0"]
...
docs = pd.read_csv(workspace + "data/train01.csv", encoding="UTF-8")
docs['article_token'] = docs.article.apply(kkma.morphs)
...
total.to_csv(workspace + "data/bows01_test.csv", index=False, encoding="utf-8-sig")